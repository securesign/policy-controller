...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TrustRoot, desiredFinalizers sets.Set[string]) (*v1alpha1.TrustRoot, error) {
	// Don't modify the informers copy.
