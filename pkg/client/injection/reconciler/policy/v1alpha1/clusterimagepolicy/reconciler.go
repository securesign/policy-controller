...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ClusterImagePolicy, desiredFinalizers sets.Set[string]) (*v1alpha1.ClusterImagePolicy, error) {
	// Don't modify the informers copy.
