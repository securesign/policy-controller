...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/k8schain 9db1ad671444
	github.com/google/go-containerregistry/pkg/authn/kubernetes 9db1ad671444
...
replace (
	...
	k8s.io/kube-openapi => k8s.io/kube-openapi aa012df4f4af
)
