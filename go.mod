...
require (
	...
	github.com/letsencrypt/boulder v0.20260825.0
...
require (
	...
	github.com/sigstore/scaffolding v0.7.37
...
require (
	...
	gitlab.com/gitlab-org/api/client-go/v2 v2.61.0 // indirect
...
replace (
	...
	go.opentelemetry.io/contrib/instrumentation/runtime => go.opentelemetry.io/contrib/instrumentation/runtime v0.71.0
	go.opentelemetry.io/otel => go.opentelemetry.io/otel v1.46.0
	go.opentelemetry.io/otel/exporters/stdout/stdouttrace => go.opentelemetry.io/otel/exporters/stdout/stdouttrace v1.46.0
